...
export default function Home() {
    ...
    return (
        <main>
            <section className="flex gap-4 md:gap-8 h-screen text-sm -mt-20">
                <Image
                    className="w-6 object-right md:w-1/6 object-cover py-24"
                    src={heroLeft}
                    alt="left decoration"
                    width={537}
                    height={797}
                />
                <div className="flex flex-col gap-4 items-center justify-center w-full lg:p-8 text-center">
                    <h1 className="text-4xl font-semibold">Search</h1>
                    <p>Search high-resolution images from Unsplash</p>
                    <input
                        onKeyDown={(e) =>
                            e.key === 'Enter' && findParams(search)
                        }
                        value={search}
                ...
                <Image
                    className="w-6 md:w-1/6 object-left object-cover py-24"
                    src={heroRight}
                    alt="left decoration"
                    width={537}
                    height={797}
